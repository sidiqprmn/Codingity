...
export default function Login() {
  ...
  return (
    <div
    className="bg-no-repeat bg-center bg-cover w-full h-full filter-brightness-1 transition duration-1000 ease-in-out"
    style={{
  ...
  >
      <div className="container pt-5 px-20 md:px-8" style={{ zIndex: "11px" }}>
        <section className="flex items-center md:justify-center">
          <img className="w-28 h-28" src="./logoTab.png" alt="" />
          <p className="text-white text-4xl">
            Codingity{" "}
            <span>
              <p className="text-sm">Let’s Start Coding</p>
            </span>
          </p>
        </section>
